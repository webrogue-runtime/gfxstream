...
// ../../../../../../external/gfxstream/third_party/vulkan_docs/xml/vk.xml -registryGfxstream
// xml/vk_gfxstream.xml cereal -o ../../../../../../external/gfxstream/host/vulkan/cereal
//
...
class VkDecoderSnapshot::Impl {
   public:
    ...
    void vkDestroySurfaceKHR(gfxstream::base::BumpPool* pool, VkSnapshotApiCallHandle apiCallHandle,
                             const uint8_t* apiCallPacket, size_t apiCallPacketSize,
                             VkInstance instance, VkSurfaceKHR surface,
                             const VkAllocationCallbacks* pAllocator) {
        std::lock_guard<std::mutex> lock(mReconstructionMutex);
        // surface destroy
        mReconstruction.removeHandles((const uint64_t*)(&surface), 1, true);
    }
    void vkGetPhysicalDeviceSurfaceSupportKHR(gfxstream::base::BumpPool* pool,
                                              VkSnapshotApiCallHandle apiCallHandle,
                                              const uint8_t* apiCallPacket,
                                              size_t apiCallPacketSize, VkResult input_result,
                                              VkPhysicalDevice physicalDevice,
                                              ...
                                              VkBool32* pSupported) {}
    void vkGetPhysicalDeviceSurfaceCapabilitiesKHR(gfxstream::base::BumpPool* pool,
                                                   VkSnapshotApiCallHandle apiCallHandle,
                                                   const uint8_t* apiCallPacket,
                                                   size_t apiCallPacketSize, VkResult input_result,
                                                   VkPhysicalDevice physicalDevice,
    ...
    void vkGetPhysicalDeviceSurfaceFormatsKHR(gfxstream::base::BumpPool* pool,
                                              VkSnapshotApiCallHandle apiCallHandle,
                                              const uint8_t* apiCallPacket,
                                              size_t apiCallPacketSize, VkResult input_result,
...
#endif
#ifdef VK_KHR_surface
void VkDecoderSnapshot::vkDestroySurfaceKHR(gfxstream::base::BumpPool* pool,
                                            VkSnapshotApiCallHandle apiCallHandle,
                                            const uint8_t* apiCallPacket, size_t apiCallPacketSize,
                                            VkInstance instance, VkSurfaceKHR surface,
                                            const VkAllocationCallbacks* pAllocator) {
    mImpl->vkDestroySurfaceKHR(pool, apiCallHandle, apiCallPacket, apiCallPacketSize, instance,
                               surface, pAllocator);
}
#endif
#ifdef VK_KHR_surface
void VkDecoderSnapshot::vkGetPhysicalDeviceSurfaceSupportKHR(
    ...
    VkBool32* pSupported) {
    mImpl->vkGetPhysicalDeviceSurfaceSupportKHR(pool, apiCallHandle, apiCallPacket,
                                                apiCallPacketSize, input_result, physicalDevice,
...
void VkDecoderSnapshot::vkGetPhysicalDeviceSurfaceCapabilitiesKHR(
    ...
    VkPhysicalDevice physicalDevice, VkSurfaceKHR surface,
    VkSurfaceCapabilitiesKHR* pSurfaceCapabilities) {
    mImpl->vkGetPhysicalDeviceSurfaceCapabilitiesKHR(pool, apiCallHandle, apiCallPacket,
                                                     apiCallPacketSize, input_result,
...
void VkDecoderSnapshot::vkGetPhysicalDeviceSurfaceFormatsKHR(
    ...
    VkSurfaceFormatKHR* pSurfaceFormats) {
    mImpl->vkGetPhysicalDeviceSurfaceFormatsKHR(pool, apiCallHandle, apiCallPacket,
                                                apiCallPacketSize, input_result, physicalDevice,
...
void VkDecoderSnapshot::vkGetPhysicalDeviceSurfacePresentModesKHR(
    ...
    VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pPresentModeCount,
    VkPresentModeKHR* pPresentModes) {
    mImpl->vkGetPhysicalDeviceSurfacePresentModesKHR(
        pool, apiCallHandle, apiCallPacket, apiCallPacketSize, input_result, physicalDevice,
