...
#  endif
      ...
      VULKAN_HPP_RAII_CREATE_NOEXCEPT
    {
      VULKAN_HPP_ASSERT(
        ...
        "createInfo.flags need to have vk::DescriptorPoolCreateFlagBits::eFreeDescriptors set in order to allow destruction of VULKAN_HPP_NAMESPACE::VULKAN_HPP_RAII_NAMESPACE::DescriptorSet which requires to return individual allocations to the pool" );
